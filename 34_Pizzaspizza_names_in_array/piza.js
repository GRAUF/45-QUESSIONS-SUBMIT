...
let pizzas = [`pepperoni pizza`, `Chicken_Fajita`, `Chicken Tikka`, `Hawaiian pizza`, `Italiano Crust`, `Crunchy_Thin_Crust`, `Smokey Bar bq Pizza`, `California Pizza`, `Afghani_Botti`];

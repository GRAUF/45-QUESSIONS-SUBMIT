...
console.log("inequality test with string: " , ("Apple" as string)  != "Bannana");     // Answer wiil True.
...
console.log("inequality test with number: " , (9 as Number) != 19);  // Answer will True.
...
console.log("using or test: " , (10 as number) === 10 || 10 < 9 ); // (||= or),,,(||=pipe symbol)  // Answer will True.

//Test whether an item is in a array:
const city: string[] = [`karachi`,`multan`,`nawabsha`,`okara`]

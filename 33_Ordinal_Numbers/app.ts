...
let numbers: number[] = [100000000000,20000000000,3000000000,40000000,5000000,600000,70000,8000,900,10,11,12,130,1400,15000,160000,17000000,1800000000,19000000000,20000000000,100000000000];
